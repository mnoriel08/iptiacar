...
pistaBordeMin     = 30			# ancho minimo borde de pista
...
if __name__ == "__main__":
	logging.basicConfig(filename='iptiacar.log', filemode='w', format='%(name)s - %(asctime)s - %(process)d - %(levelname)s  %(message)s', datefmt='%d-%b-%y %H:%M:%S')
